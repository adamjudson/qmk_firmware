...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_reviung39(
    ...
    KC_TRANSPARENT, KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         KC_F12,         KC_AUDIO_MUTE,  KC_LABK,        KC_RABK,        KC_QUES,        KC_DQUO,        
                                             KC_TRANSPARENT, MO(3), KC_TRANSPARENT
  ),

  [2] = LAYOUT_reviung39(
    KC_GRAVE,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_6,           KC_7,           KC_8,           KC_9,           KC_MEDIA_PLAY_PAUSE,   KC_TRNS,
    KC_TRANSPARENT, KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_F6,          KC_UP,       KC_EQUAL,       KC_LBRACKET,         KC_UP,                 KC_BSLASH,      
    KC_TRANSPARENT, KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         KC_LEFT,        KC_DOWN,     KC_RIGHT,    KC_AUDIO_VOL_DOWN,       KC_AUDIO_VOL_UP,        KC_AUDIO_MUTE,
                                                                  MO(3),   KC_TRNS, KC_AUDIO_MUTE
  ),
  ...
  [7] = LAYOUT_reviung39(
    ...
    OSM(MOD_LGUI), OSM(MOD_LCTL),  KC_TRANSPARENT, KC_TRANSPARENT, LCTL(KC_F),     KC_TAB,         KC_TRANSPARENT, KC_TRANSPARENT, KC_LGUI,        LGUI(KC_L),     KC_LALT,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                            KC_TRNS,   KC_TRNS,    KC_TRNS
  ),
