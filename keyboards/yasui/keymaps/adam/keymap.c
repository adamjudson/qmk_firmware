...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
        ...
        KC_NO,    KC_TRNS,    KC_NO,      KC_TRNS,      KC_UNDS,       KC_PMNS,      KC_P4,      KC_P5,          KC_P6,    KC_PPLS,   
        KC_NO,    KC_NO,      KC_NO,      KC_LGUI,      KC_NO,         KC_PDOT,      KC_P1,      KC_P2,          KC_P3,    KC_TRNS,
        KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_LCTL,      KC_NO,         KC_NO,        KC_P0,      KC_TRNS,        KC_NO,    KC_NO     
    ),
    /* 6 - g brackets */ 
	LAYOUT(
