...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
      KC_EXLM,      KC_AT,     KC_HASH,     KC_DLR,       KC_PERC,        KC_TRNS,      KC_CIRC,      KC_AMPR,    KC_ASTR,      KC_DEL,  KC_BSPC,  
	...
	[2] = LAYOUT(
      KC_GRAVE,     KC_TILD,   KC_3,        LALT(KC_F4),   KC_5,           KC_TRNS, KC_6,         KC_7,       KC_VOLD,       KC_VOLU,   TD(TD_MEDIA),
      ...
      KC_F7,        KC_F8,     KC_F9,       KC_F10,       KC_F11,          KC_F12,       KC_MUTE,    KC_LEFT,      KC_DOWN, KC_RIGHT,     
                             OSM(MOD_LGUI), MO(3),         KC_TRNS, KC_TRNS), 
	...
	[3] = LAYOUT(
      ...
      KC_NO,                KC_NO,              KC_NO,       KC_NO,        KC_NO,             KC_NO,        RGB_MOD,  RGB_HUI,      RGB_HUD,   KC_NO, 
                                                KC_NO,     KC_TRNS,             LCA(KC_DEL),   KC_NO), 
	...
	[4] = LAYOUT(
      KC_NO,    LGUI(LCTL(KC_LEFT)), LGUI(LCTL(KC_RIGHT)),   KC_TRNS,       KC_NO,   KC_TRNS,  KC_NO,        KC_MS_WH_UP,         KC_MS_UP,      KC_MS_WH_DOWN,    KC_NO, 
      KC_NO,    KC_NO,               MO(2),                  KC_NO,          KC_NO,             KC_NO,        KC_MS_LEFT,          KC_MS_DOWN,    KC_MS_RIGHT,      KC_NO, 
      KC_TRNS,    KC_NO,               KC_NO,                  KC_NO,         KC_NO,           KC_NO,        KC_NO,               KC_NO,         KC_NO,          KC_INS, 
                                     KC_NO, KC_MS_BTN1,                                         KC_MS_BTN1,                  KC_MS_BTN2 ), 
    /* numbers */ 
	[5] = LAYOUT(
      KC_NO,            KC_NO,      KC_NO,      KC_NO,                    KC_NO,       KC_TRNS,    KC_ASTR,      KC_7,      KC_8,     KC_9,    KC_BSPC,   
      ...
      KC_NO,            KC_NO,      KC_NO,      KC_LGUI,                  KC_NO,           KC_DOT,       KC_1,      KC_2,     KC_3,    KC_TRNS,   
                                    KC_LALT,    MT(MOD_LCTL, KC_DOT),           KC_0,      KC_DOT     ),
    /* brackets - g layer */ 
	[6] = LAYOUT(
      KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_NO,        KC_NO,           KC_TRNS, KC_NO,        ARRAY,      KC_LBRC,        KC_RBRC,  ARRAY_INSIDE,  
      KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_BSPC,      KC_NO,           JSARROW,      KC_LPRN,    KC_RPRN,        KC_LCBR,  KC_RCBR,   
      KC_TRNS,  KC_TRNS,    KC_NO,      KC_NO,        KC_NO,           KC_NO,        KC_LT,      KC_GT,          END_TAG,  CLOSE_TAG,     
                            KC_TRNS,    KC_TRNS,      KC_TRNS,    KC_TRNS   ), 
    /*  os nav - j layer */ 
	[7] = LAYOUT(
      LGUI(KC_1),    LGUI(KC_2), LGUI(KC_E), LGUI(KC_4),  LGUI(KC_5),   KC_TRNS,   LGUI(KC_6),   LGUI(KC_7), LGUI(KC_8),     KC_TRNS,    KC_TRNS, 
	...
	[8] = LAYOUT(
      KC_TAB,  LCTL(KC_W), KC_TRNS,    LCTL(KC_R),   LCTL(KC_T),      KC_TRNS, KC_TRNS,      KC_PGUP,     KC_UP,       KC_PGDN,          KC_BSPC, 
      ...
      KC_LALT,  KC_TRNS,    LCTL(KC_C), LCTL(KC_V),   KC_TRNS,          KC_TRNS,      LCTL(KC_U),  KC_BSPC,     LCTL(LSFT(KC_U)), LCTL(KC_SLSH), 
                           KC_TRNS,    KC_LCTL,         LCTL(KC_C),  LCTL(KC_X)), 
    ...
    */
	[9] = LAYOUT(
      KC_TAB,    LSFT(KC_TAB), KC_TRNS,   KC_TRNS,    KC_TRNS,        KC_TRNS, KC_TRNS,         KC_TRNS,          KC_TRNS,   KC_TRNS,    KC_TRNS,  
