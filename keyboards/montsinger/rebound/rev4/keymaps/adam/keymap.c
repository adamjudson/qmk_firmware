...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LT(4,KC_ESC),   KC_A,       LT(5,KC_S), LT(9,KC_D), LSFT_T(KC_F), LT(7,KC_G),        LT(2, KC_DEL),       LSFT_T(KC_H),      LT(8,KC_J),   LT(10,KC_K),  KC_L,   KC_SCLN,  KC_QUOT, 
    KC_LSFT,        KC_Z,       KC_X,       KC_C,       KC_V,         KC_B,              LT(3, KC_SPC),  KC_N,              KC_M,         KC_COMM,      KC_DOT, KC_SLSH,  LSFT_T(KC_BSLS), 
    ...
    KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                  KC_TRNS,                                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RESET, 
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                    KC_TRNS,                                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                    KC_TRNS,                                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
    ),

	[5] = LAYOUT_all(
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                                         KC_PAST, KC_7, KC_8, KC_9, KC_PMNS, KC_TRNS, 
    KC_NO, KC_NO, KC_TRNS, KC_NO, KC_LGUI, KC_NO,                  KC_TRNS,                           KC_PMNS, KC_4, KC_5, KC_6, KC_PPLS, KC_NO, 
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                      KC_TRNS,                           KC_DOT, KC_1, KC_2, KC_3, KC_SLSH, KC_NO, 
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL,                    KC_TRNS,                           KC_0, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
    ),
    ...
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                       KC_TRNS,                          JSARROW, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_NO, 
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                        KC_TRNS,                         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                        KC_TRNS,                         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
    ),

	[8] = LAYOUT_all(
    KC_TRNS, LGUI(KC_1), LGUI(KC_2), LGUI(KC_E), LGUI(KC_4), LGUI(KC_5),                              LGUI(KC_6), LGUI(KC_7), LGUI(KC_8), KC_TRNS, LGUI(KC_P), KC_TRNS, 
    KC_NO, KC_TRNS, KC_TRNS, LGUI(KC_3), KC_TRNS, KC_TAB,                   KC_TRNS,                          KC_TRNS, KC_TRNS, KC_LGUI, LGUI(KC_L), KC_LALT, KC_NO, 
    KC_NO, KC_TRNS, LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), KC_TRNS,            KC_TRNS,                         KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, 
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_TRNS,                      KC_TRNS,                         KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
    ),
    ...
    KC_NO, KC_NO, KC_NO, KC_NO, LCTL(KC_V), KC_NO,                            LCTL(KC_X),                        KC_TRNS, KC_TRNS, KC_TRNS, JSARROW, LCTL(KC_SLSH), LCTL(KC_F), 
    ...
    KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                          KC_TRNS,                       KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, 
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                  KC_TRNS,                       KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
    )
};
