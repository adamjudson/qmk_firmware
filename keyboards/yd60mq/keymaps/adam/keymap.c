...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_all(
        ...
        KC_LSFT,   _______,    KC_Z,          KC_X,       KC_C,         KC_V,          KC_B,              KC_N,         KC_M,          KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_BSLS), KC_UP,   LT(2, KC_DEL),
	...
	[1] = LAYOUT_all(
        ...
        KC_TILD, KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_MPLY,    KC_TRNS, KC_TRNS,  KC_TRNS,
        KC_TRNS, KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_UNDS,    KC_PLUS,    KC_TRNS,    KC_TRNS,    KC_TRNS, KC_TRNS,  KC_TRNS,
        KC_TRNS, _______,  KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_MUTE,    KC_TRNS,    KC_TRNS,    KC_TRNS, KC_TRNS,  KC_VOLU, TG(6),
        KC_TRNS, KC_TRNS,  KC_TRNS,                             _______,    KC_SPC,     _______,                           KC_TRNS,    MO(3), KC_TRNS,  KC_VOLD,  KC_MFFD
    ),
	...
	[4] = LAYOUT_all(
        ...
        KC_TRNS, MO(1),               KC_TRNS,    KC_TRNS,  KC_TRNS,    KC_TRNS,       KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,
        KC_TRNS, _______,             KC_TRNS,    KC_TRNS,  KC_TRNS,    KC_TRNS,       KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS,             KC_TRNS,                           _______,      KC_TRNS,    _______,                            KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS
    ),
	...
	[5] = LAYOUT_all(
        ...
        KC_TRNS, _______,  KC_TRNS,    KC_TRNS,    KC_LCTL,    KC_TRNS,    KC_TRNS,    KC_DOT,     KC_1,       KC_2,       KC_3,       KC_SLSH, KC_TRNS,  KC_TRNS, KC_TRNS,
	...
	[7] = AJ_LAYOUT(
        ...
        KC_TRNS, _______,  KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    __AJ__G__n_dot__,                                KC_TRNS,    KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS,  KC_TRNS,                            _______,    KC_TRNS,     _______,                            KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
