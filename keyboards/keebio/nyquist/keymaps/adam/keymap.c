...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT_ortho_4x12(KC_DEL, LGUI(LCTL(KC_LEFT)), LGUI(LCTL(KC_RIGHT)), LGUI(KC_E), LALT(KC_F4), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RESET, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
	[5] = LAYOUT_ortho_4x12(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PAST, KC_7, KC_8, KC_9, KC_PMNS, KC_TRNS, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_LGUI, KC_NO, KC_PMNS, KC_4, KC_5, KC_6, KC_PPLS, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_NO, KC_DOT, KC_1, KC_2, KC_3, KC_SLSH, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_NO, KC_0, KC_DOT, KC_NO, KC_NO, KC_NO, KC_NO),
	...
	[9] = LAYOUT_ortho_4x12(KC_NO, KC_NO, LCTL(KC_W), KC_NO, LCTL(KC_R), LCTL(KC_T), KC_NO, KC_PGUP, KC_UP, KC_PGDN, KC_NO, KC_BSPC, KC_NO, KC_BSPC, KC_DEL, KC_TRNS, KC_LSFT, LCTL(KC_TAB), KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END, LCTL(KC_L), KC_NO, KC_NO, KC_NO, KC_NO, LCTL(KC_V), KC_NO, KC_NO, KC_NO, KC_NO, JSARROW, LCTL(KC_SLSH), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, LCTL(KC_C), LCTL(KC_C), LCTL(KC_X), KC_NO, KC_NO, KC_NO, KC_NO),
