...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
        ...
        KC_TRNS,      KC_TRNS,   KC_TRNS,     MO(3),        KC_NO,           KC_TRNS,        KC_TRNS,    KC_TRNS,      KC_VOLD,    KC_VOLU
    ), 
	...
	LAYOUT(
        ...
        KC_NO,                 KC_NO,     KC_NO,       KC_TRNS,      KC_NO,             KC_TRNS,    LCA(KC_DEL),  KC_TRNS,      KC_NO,   KC_NO
    ), 
	...
	LAYOUT(
        ...
        KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_LCTL,      KC_NO,            LCTL(KC_C),        LCTL(KC_C),  LCTL(KC_X),    LCTL(KC_U),         LCTL(LSFT(KC_U))
    ), 
    /* 9 - k ctrl */ 
	LAYOUT(
