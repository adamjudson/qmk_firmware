...
// which means keys 3/5 are dead.  And 7 (so 6 and 7 are duplicates)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
        ...
        KC_LCTL,             KC_LGUI,               KC_LALT,    LT(1,KC_ENT), KC_NO,      LSFT_T(KC_SPC), LSFT_T(KC_SPC),  MO(2),       KC_ESC, KC_BSPC   
    ), 
    /* 1 - lower */
	...
	LAYOUT(
        ...
        KC_TRNS,      KC_TRNS,   KC_TRNS,     MO(3),        KC_NO,      KC_TRNS, KC_TRNS,    KC_NO,     KC_VOLD,    KC_VOLU
    ), 
	...
	LAYOUT(
        ...
        KC_NO,                 KC_NO,     KC_NO,       KC_TRNS,      KC_NO,    LCA(KC_DEL),  KC_NO,    KC_TRNS,      KC_NO,   KC_NO
    ), 
	...
	LAYOUT(
       ...
       KC_TRNS,    KC_TRNS,               KC_NO,                  KC_MS_BTN1,    KC_NO,   KC_MS_BTN1,   KC_NO,               KC_MS_BTN2,    KC_VOLD,    KC_VOLU 
    ), 
    /* 5 - s numbers - and tab I guess */ 
	LAYOUT(
        KC_NO,              KC_NO,      KC_TRNS,      KC_NO,                KC_NO,         KC_ASTR,      KC_7,      KC_8,           KC_9,    KC_BSPC,  
        ...
        KC_TRNS,            KC_TRNS,    KC_TRNS,    MT(MOD_LCTL, KC_DOT),   KC_NO,         KC_0,         KC_NO,     KC_DOT,         KC_TRNS, KC_TRNS     
    ),
    /* 6 - g brackets */ 
	LAYOUT(
        ...
        KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_NO,        KC_NO,                KC_TRNS,      KC_TRNS,    KC_NO,          KC_NO,    KC_NO   
    ), 
    /* 7 - j  os nav */ 
	LAYOUT(
        ...
        KC_TRNS,       KC_TRNS,    KC_TRNS,    KC_BSPC,    KC_NO,           KC_TRNS,      KC_TRNS,    KC_NO,          KC_NO,      KC_NO
    ), 
    /* 8 - d nav */ 
	LAYOUT(
        ...
        KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_LCTL,      KC_NO,            LCTL(KC_C),   KC_NO,       LCTL(KC_X),    LCTL(KC_U),         LCTL(LSFT(KC_U))
    ), 
    /* 9 - k ctrl */ 
	LAYOUT(
